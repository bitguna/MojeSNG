...
public  class MainActivity extends AppCompatActivity
    ...
    private void setPermissions() {
        ActivityCompat.requestPermissions(this, new String[]{
                android.Manifest.permission.CAMERA, android.Manifest.permission.ACCESS_FINE_LOCATION, android.Manifest.permission.GET_ACCOUNTS, android.Manifest.permission.READ_CONTACTS, android.Manifest.permission.ACCESS_COARSE_LOCATION,
                android.Manifest.permission.INTERNET , android.Manifest.permission.READ_EXTERNAL_STORAGE, Manifest.permission.WRITE_EXTERNAL_STORAGE  }, 1);
    }
    ...
    protected void onCreate(Bundle savedInstanceState) {
     ...
     // if(getResources().getBoolean(R.bool.portrait_only)){
      ...
      //    }
        ...
        Log.d("TOKEN","TWOJ TOKEN");
        Log.d("token",FirebaseInstanceId.getInstance().getToken());
        Log.d("token", Integer.toString(Build.VERSION.SDK_INT));
        ...
        prefs = getSharedPreferences("pl.com.sng.sngtwojewodociagi", MODE_PRIVATE);
